...
import com.example.demo.pojo.PublicResVO;
...
public class AESUtil {
     ...
     * @param
     */
    public static boolean verifySign(PublicResVO publicResVO) {

        //使用seckey对除sign以外的公共参数进行md5加密生成sign值
        String toSignStr = "Code=" + publicResVO.code + "&Result=" + publicResVO.result + "&Key=" + PublicParam.SECRET;
